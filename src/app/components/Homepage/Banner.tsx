...
const Banner = () => {
  return (
    <div className="bg-[#12141c] border border-zinc-800/80 rounded-2xl lg:rounded-3xl grid grid-cols-1 lg:grid-cols-2 items-center gap-8 px-4 sm:px-6 py-8 sm:py-12 lg:px-16 lg:py-16 my-4 lg:my-6 mx-2 sm:mx-4">
      ...
      <div className="flex justify-center lg:justify-end">
        <div className="relative w-full max-w-[280px] sm:max-w-md h-64 sm:h-72 lg:h-96">
          <Image 
            src={bannerImage} 
